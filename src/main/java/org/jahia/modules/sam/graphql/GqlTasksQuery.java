...
public class GqlTasksQuery {
    ...
    @GraphQLField
    @GraphQLName("tasks")
    @GraphQLDescription("Tasks running on the Jahia server. A server should not be stopped/restarted when any of these tasks are present. These tasks are specific to the server being queried and are not shared accorss a cluster")
